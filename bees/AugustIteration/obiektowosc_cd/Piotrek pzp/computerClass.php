...
class ComputerShop {
    ...
    public function __construct($audio = 0, $hardwar = 'towerPC', $memory = 0, $motherB = 0, $video = 0) { //todo: Parametry domyślne głównego konstruktora
...
//        $this->userComputerType = $computerHardware->ShowComputerType();
    ...
    public function ShowMyDreamComputer() {
        return
                'My dream computer brand is: ' . $this->hardwareType->userType . "<br>" .
                'My dream motherboard brand is: ' . $this->motherboard->userMotherboard . "<br>" .
                'My dream audiocard brand is: ' . $this->audioCard->userAudio . "<br>" .
                'My dream videocard brand is: ' . $this->videoCard->userVideo . "<br>" .
                'My dream meomory RAM brand is: ' . $this->memoryRAM->userMemory . "<br>";
    }
...
class ComputerVideoCard {
    ...
    protected $videoCardBrands = array('Nvidia', 'Radeon');
    protected $userVideo;
